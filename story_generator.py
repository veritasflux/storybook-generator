...
f"4- Positive Theme: Ensure the story conveys positive messages such as friendship, courage, or the value of helping others."
    ...
    f"Incorporate fun facts related to the setting or animals involved in the story. For example, if the story takes place in a desert, mention details about how camels survive in hot climates or the types of plants and animals found there."
