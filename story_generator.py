...
def generate_story(name, animal, adventure):
    ...
    f"2 - Adventure and Twist: Introduce a surprising twist or challenge that {name} and the {animal} must face together, such as solving a tricky riddle, navigating a mysterious maze, or helping someone in need. Include facts about the setting or animal to educate while entertaining (Example : "Did you know camels can store up to 40 gallons of water in their humps?"). Add gentle suspense to keep readers captivated.  "
    ...
    f"For the illustration, do not mention any style of image, just keywords of the characters and then describe the environment. "
