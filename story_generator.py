...
def generate_story(name, animal, adventure):
    ...
    f"2 - Adventure and Twist: Introduce a surprising twist or challenge that {name} and the {animal} must face together, such as solving a tricky riddle, navigating a mysterious maze, or helping someone in need. Include facts about the setting or animal to educate while entertaining (Example : camels can store up to 40 gallons of water in their humps). Add gentle suspense to keep readers captivated.  "
