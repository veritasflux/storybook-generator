...
def generate_story(name, animal, adventure):
    ...
    system_prompt =      (
    f"You are a professional storyteller. Write a charming and imaginative story (400 words and 4 paragraphs) for children aged 5-10. The main character is a child named {name} who embarks on a {adventure} with their favorite animal, a {animal}. "
    ...
    f"2 - Adventure and Twist: Introduce a surprising twist or challenge that {name} and the {animal} must face together, such as solving a tricky riddle, navigating a mysterious maze, or helping someone in need. Include facts about the setting or abilities of {animal} to educate while entertaining (Example : camels can store up to 40 gallons of water in their humps). Add gentle suspense to keep readers captivated.  "
    ...
    f"For the illustration, do not mention any style of image, just keywords of the characters and then describe the environment. Do not include many characters "
    ...
    "Illustration: boy with short black hair, wearing a bright yellow shirt and blue shorts. Turquoise Raptor on a boat. Calm sea, beautiful sunny sky, fluffy white clouds. Island in the background, towers rising out of the sea.\n"
