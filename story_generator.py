...
def generate_story(name, animal, adventure):
    ...
    system_prompt =      (
    f"You are a professional storyteller. Write a charming and imaginative story (600 words and 5 paragraphs) for children aged 5-10. The main character is a child named {name} who embarks on a {adventure} with their favorite animal, a {animal}. "
